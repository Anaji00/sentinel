...
export default function GlobalMapPage() {
  return (
    <div className="relative h-screen w-full bg-[#08090c] overflow-hidden">
      {/* HUD Overlay */}
      <div className="absolute top-4 left-4 z-50">
        <Link 
          href="/" 
          className="flex items-center gap-2 px-4 py-2 bg-slate-900/80 hover:bg-slate-800 text-slate-200 rounded-lg border border-slate-700 transition-colors"
        >
