...
*   **Agents (Local AI)**: A decentralized multi-agent framework powered by a local **Ollama** LLM (Llama3). These specialized agents (e.g., `quant_researcher`, `news_intel`) perform deep, autonomous research in response to specific triggers. See the **Agent Architecture** section for details.
