...
*   **Reasoning (Enterprise)**: Powered by Gemini 2.5 Pro, this service performs higher-level analysis by synthesizing tactical scenarios from correlated data. It features an autonomous feedback loop that dynamically updates collector watchlists based on AI-derived recommendations.
